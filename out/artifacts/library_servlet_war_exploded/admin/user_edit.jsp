    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".ajax-post").click(function () {
                ...
                $.post(
                    "${pageContext.request.contextPath}/user?method=editUserInfo",
                    $("#postForm").serialize(),
                    function(data) {
                        //返回值为 0 代表登录成功
                        if (data.code === 0) {
                                ...
                                <form action="" method="post" class="post-form" id="postForm" onsubmit="return false;">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <img id="avatar" class="img-avatar mr-3" width="80px" height="80px"
                                             src="../static/LightYearAdmin/images/users/${user.avatar}"/>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="clearfix">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="statusOne" name="type" class="custom-control-input" value="0"
                                                   ${user.getType().equals("0") ? "checked" : ""}>
                                                <label class="custom-control-label" for="statusOne">管理员</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="statusTwo" name="type" class="custom-control-input" value="1"
                                                    ${user.getType().equals("1") ? "checked" : ""}>
                                                <label class="custom-control-label" for="statusTwo">普通用户</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="clearfix">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="statusTwo" name="status" class="custom-control-input" value="0"
                                                   ${user.getStatus().equals("0") ? "checked" : ""}>
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="statusOne" name="status" class="custom-control-input" value="1"
                                                    ${user.getStatus().equals("1") ? "checked" : ""}>
