                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="R" items="${readerList}"  >
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default" href="${pageContext.request.contextPath}/user?method=editPage&id=${R.id}"
                                                           title="" data-toggle="tooltip" data-original-title="编辑"><i class="mdi mdi-pencil"></i></a>
                                                        <a class="btn btn-xs btn-default ajax-get confirm" href="${pageContext.request.contextPath}/user?method=deleteById&id=${R.id}&type=reader"
                                                    ...
                                                    <div class="btn-group">
                                                        <div class="btn-group">
                                                            <a class="btn btn-purple btn-xs" href="borrow?method=borrowDetailList&readerID=${R.id}" title="查询借阅记录" >借阅记录</a>&nbsp;
                                                            <a class="btn btn-pink btn-xs" href="borrow?method=borrowDetailList&readerID=${R.id}&isNull=T" title="查询未归还记录">未归还</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
