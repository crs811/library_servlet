    ...
    <script type="text/javascript">
        ...
        $(function(){
            $(".ajax-post").click(function () {
                ...
                $.post(
                    "${pageContext.request.contextPath}/login?method=login",
                    $("#userForm").serialize(),
                    function(data) {
                        //返回值为 0 代表登录成功
                        if (data.code === 0) {
...
<%--        <a href="#"> <img alt="light year admin" src="static/LightYearAdmin/images/logo-sidebar.png"> </a>--%>
        <h2 class="mb-0 font-weight-bold" >图书管理系统</h2>
    </div>
    ...
    <form action="#" method="post" class="login-form" id="userForm" onsubmit="return false">
        ...
        <div class="form-group has-feedback row">
            ...
            <div class="col-5 text-right">
                <img src="${pageContext.request.contextPath}/captcha" class="pull-right" id="captcha" style="cursor: pointer;"
                     onclick="this.src='<%=request.getContextPath()%>/captcha?t='+ new Date().getTime();"
        ...
        <div class="form-group row">
            ...
            <div class="col-4">
                <a class="btn btn-info btn-round" href="login?method=visitorLogin" title="以游客身份登录，查询和注册">游客登录</a>
            </div>
        </div>
    </form>
