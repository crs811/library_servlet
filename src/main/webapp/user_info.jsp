    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".ajax-post").click(function () {
                ...
                $.post(
                    "${pageContext.request.contextPath}/user?method=userUpdate",
                    $("#postForm").serialize(),
                    function(data) {
                        //返回值为 0 代表登录成功
                        if (data.code === 0) {
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="post" class="post-form" id="postForm" onsubmit="return false">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="username" name="username" value="${currentUser.username}" placeholder="请输入用户名" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="title">密码</label><span class="text-danger">*</span>
                                        <input type="password" class="form-control" id="password" name="password" value="${currentUser.password}" placeholder="请输入密码" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="title">昵称</label><span class="text-danger">*</span>
                                        <input type="text" class="form-control" id="nickname" name="nickname" value="${currentUser.nickname}" placeholder="请输入昵称" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="avatar">头像</label><br/>
                                        <img id="avatar" class="img-avatar mr-3" width="80px" height="80px"
                                             src="static/LightYearAdmin/images/users/${currentUser.avatar}"/>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="telephone" name="telephone" value="${currentUser.telephone}" placeholder="请输入电话" />
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="title">邮箱</label>
                                        <input type="text" class="form-control" id="email" name="email" value="${currentUser.email}" placeholder="请输入邮箱" />
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="clearfix">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="typeOne" name="type" class="custom-control-input" checked value="0">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="clearfix">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="statusTwo" name="status" class="custom-control-input"
                                                        ${currentUser.status == 0? 'checked' : ''} value="0">
                                                <label class="custom-control-label" for="statusTwo">启用</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="statusOne" name="status" class="custom-control-input"
                                                        ${currentUser.status == 1? 'checked' : ''} value="1">
