        ...
        <ul class="navbar-right d-flex align-items-center">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <div class="lyear-notifications">
                        ...
                        <div class="lyear-notifications-info lyear-scroll">
                            <a href="#!" class="dropdown-item" title="《书籍1》还有10天到期">《书籍1》还有10天到期</a>
                        </div>
            ...
            <li class="dropdown dropdown-profile">
                <a href="javascript:void(0)" data-toggle="dropdown" class="dropdown-toggle">
                    <img class="img-avatar img-avatar-48 m-r-10" src="../static/LightYearAdmin/images/users/<%=currentUser.getAvatar()%>"/>
                    <span><%=currentUser.getNickname()%></span>
                </a>
