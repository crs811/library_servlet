...
<head>
    ...
    <script type="text/javascript">
        ...
        %>
        $.get("${pageContext.request.contextPath}/book?method=bookEditPage&id=<%=bookID%>", function (data) {
            if (data.code === 0) {
                console.log(data)
                let book = data.data;
                ...
                $("#bookSum").val(book.bookSum);
                $("#bookLend").val(book.bookLend);
                $("#tag").val(book.tag);
                $("#isbn").val(book.isbn);
            } else {
                alert("获取书籍信息失败");
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="post" class="post-form" id="postForm" onsubmit="return false;">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="price" name="bookPrice" value="" placeholder="请输入价格" />
                                    </div>
                                    <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="bookLend" name="bookLend" value="" placeholder="请输入借出数量" />
                                    </div>
                                    <div class="form-group col-md-12">
