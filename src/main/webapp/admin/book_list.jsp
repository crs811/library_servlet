                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="B" items="${bookList}"  >
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default" href="${pageContext.request.contextPath}/admin/book_edit.jsp?id=${B.bookID}"
                                                        ...
                                                        <a class="btn btn-xs btn-default ajax-get confirm" href="book?method=bookDelete&id=${B.bookID}"
                                                           onclick="return confirm('确认删除 ${B.bookName} 吗？');"  title="" data-toggle="tooltip" data-original-title="删除">
                                                            <i class="mdi mdi-window-close"></i>
                                                        </a>
                                                    </div>
                                                    <div class="btn-group">
                                                        <a class="btn btn-purple btn-xs" href="borrow?method=borrowDetailSearch&bookID=${B.bookID}" title="查询借阅记录" >借阅记录</a>&nbsp;
                                                        <a class="btn btn-pink btn-xs" href="borrow?method=borrowDetailSearch&bookID=${B.bookID}&isNull=T" title="查询未归还记录">未归还</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </c:forEach>
