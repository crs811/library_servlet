                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-toolbar d-flex flex-column flex-md-row">
                                ...
                                <form class="search-bar ml-md-auto" method="post" action="${pageContext.request.contextPath}/user?method=adminSearch" role="form">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="U" items="${adminList}"  >
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default" href="${pageContext.request.contextPath}/admin/user_edit.jsp?id=${U.id}"
                                                           title="" data-toggle="tooltip" data-original-title="编辑"><i class="mdi mdi-pencil"></i></a>
                                                        <a class="btn btn-xs btn-default ajax-get confirm" href="${pageContext.request.contextPath}/user?method=deleteById&id=${U.id}&type=0"
